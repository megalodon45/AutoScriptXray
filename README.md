</p> <h2 align="center"> Supported Linux Distribution</h2>
...
# Pointing
![Pointing](https://raw.githubusercontent.com/megalodon45/AutoScriptXray/master/image/pointing.png)
...
```
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/megalodon45/AutoScriptXray/master/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
```
...
[![QRIS donate button](https://img.shields.io/badge/Donate-QRIS-red)](https://telegra.ph/file/3ce41bc0e7002cf8f4452.jpg)
