...
echo -e "Port NS     : ALL Port (22, 443, 143, 53, 5300)" | tee -a /etc/log-create-ssh.log
...
echo -e "
GET / HTTP/1.1[crlf]Host: ${domen}[crlf]Upgrade: websocket[crlf]Connection: Keep-Alive[crlf][crlf]
