...
wget https://raw.githubusercontent.com/megalodon45/AutoScriptXray/master/ssh/cf && chmod +x cf && ./cf
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/megalodon45/AutoScriptXray/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/megalodon45/AutoScriptXray/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/megalodon45/AutoScriptXray/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/megalodon45/AutoScriptXray/master/menu/versi  )
...
echo "---------------------------t.me/mzx45-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
